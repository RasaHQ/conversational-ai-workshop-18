...
train-compare:
	python -m rasa_core.train compare --stories data-simulated/train -d domain.yml -o comparison_models -c redp_topics.yml redp.yml --augmentation 0 --runs 5

evaluate-compare:
	python -m rasa_core.evaluate compare --stories data-simulated/test --core comparison_models -o results/
